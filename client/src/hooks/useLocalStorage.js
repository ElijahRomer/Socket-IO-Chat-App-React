...
const PREFIX = 'Socket-IO-Chat-App-';
...
export default function useLocalStorage(key, initialValue) {
  ...
  useEffect(() => {
    // store the value of the value state into localStorage with the prefixedKey, and the stringified value of the value state
    localStorage.setItem(prefixedKey, JSON.stringify(value));
    // run this hook any time the prefixedKey changes, or the value changes.
  }, [prefixedKey, value]);
